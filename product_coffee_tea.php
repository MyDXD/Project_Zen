...
<head>
    ...
    <title>สินค้าชา/กาแฟสำเร็จรูป</title>
    <style>
        .product_container {
            display: flex;
            flex-wrap: wrap;
...
<body>
    ...
    ?>
    <h2 style="text-align: center;">สินค้าชา/กาแฟสำเร็จรูป</h2>
    <div class="product_container">
        ...
        if (isset($_POST['search'])) {
            ...
            $sql = "SELECT * FROM `productdata` WHERE `product_type` = 'ชา/กาแฟ' AND `product_name` LIKE '%$search%'";
        } else {
            $sql = "SELECT * FROM `productdata` WHERE `product_type` = 'ชา/กาแฟ'";
        }
        $result = $db->query($sql);
