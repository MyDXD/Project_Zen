...
<body>
    ...
    ?>
    <h2 style="text-align: center;">สินค้าตากแห้ง</h2>
    <div class="product_container">
        ...
        if (isset($_POST['search'])) {
            ...
            $sql = "SELECT * FROM `productdata` WHERE `product_type` = 'ตากแห้ง' AND `product_name` LIKE '%$search%'";
        } else {
            $sql = "SELECT * FROM `productdata` WHERE `product_type` = 'ตากแห้ง'";
        }
        $result = $db->query($sql);
