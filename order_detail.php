...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto mt-10">
        <h1 class="text-3xl font-bold mb-5 text-center">
            รหัสคำสั่งซื้อ : <?php echo $order_code; ?>
        </h1>
        <h3 class="text-2xl font-bold mb-5 text-center">
            สถานที่จัดส่ง : <?php echo $delivery_address; ?>
        </h3>
                    ...
                    <thead>
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                สินค้า</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">จำนวน
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                ราคาต่อชิ้น</th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        ...
                        <?php while ($item = mysqli_fetch_assoc($order_items_result)): ?>
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <p>ชื่อสินค้า : <?php echo $item['product_name']; ?></p>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php echo number_format($item['price'] * $item['quantity'], 2); ?> บาท</td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
                </table>
